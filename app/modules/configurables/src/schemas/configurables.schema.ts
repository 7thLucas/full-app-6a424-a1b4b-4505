...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "rfqItemsPerPage",
      type: "number",
      required: false,
      label: "RFQ Items Per Page",
      min: 5,
      max: 100,
    },
    {
      fieldName: "enableBuyerRegistration",
      type: "boolean",
      required: false,
      label: "Enable Buyer Registration",
    },
    {
      fieldName: "enableNegotiationChat",
      type: "boolean",
      required: false,
      label: "Enable Negotiation Chat",
    },
    {
      ...
      options: ["USD", "EUR", "GBP", "JPY", "CNY", "AUD", "CAD", "SGD"],
    },
    {
      fieldName: "defaultIncoterm",
      type: "enum",
      required: false,
      label: "Default Incoterm",
      options: ["EXW", "FOB", "CIF", "DDP", "FCA", "CPT", "CIP", "DAP", "DPU"],
    },
    // ── Content / Copy ────────────────────────────────────────────────────────
    {
    ...
    {
      fieldName: "catalogSubheading",
      type: "string",
      required: false,
      label: "Catalog Section Subheading",
      maxLength: 300,
    },
    {
      fieldName: "font",
